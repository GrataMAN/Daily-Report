...
const motivations = [
    ...
    "Сообщается, что Ибн ‘Умар, да будет доволен Аллах ими обоими, сказал: «Посланник Аллаха ﷺ сказал: Подстригайте усы и отпускайте бороды",
    "Облегчайте, а не создавайте затруднения, возвещайте благое, а не внушайте отвращение (к Исламу). (Бухари, Муслим)",
    "Если ты не чувствуешь стыда, делай что хочешь». (Бухари)",
    "Поистине, Аллах любит, когда вы выполняете свою работу добросовестно. (Аль-Байхаки)",
    "Все сыны Адама ошибаются, а лучшими из ошибающихся, являются кающиеся» (Тирмизи)",
    "Кто нас обманывает, тот не из нас. (Муслим)",
    "Сплетник не войдет в Рай!. (Бухари, Муслим)",
    "Расплатитесь с наёмным работником, пока не высохнет его пот. (Ибн Маджа)",
    "Вы не войдете в Рай, пока не уверуете и вы не уверуете, пока не полюбите друг друга. (Муслим, Тирмизи)"
];

// Массив аятов
const ayats = [
    "
وَٱسۡتَعِينُواْ بِٱلصَّبۡرِ وَٱلصَّلَوٰةِ ۚ وَإِنَّهَا لَكَبِيرَةٌ إِلَّا عَلَى ٱلۡخَٰشِعِينَ ,
